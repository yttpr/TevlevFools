...
// Type: TevlevsRapscallions.ApplyMutalismBasedOnPreviousAmount
...
{
  public class ApplyMutalismBasedOnPreviousAmount : EffectSO
  {
    [SerializeField]
      ...
      out int exitAmount)
    {
      ...
      for (int index = 0; index < targets.Length; ++index)
      {
        if (targets[index].HasUnit)
        {
          ...
          int num = targets[index].Unit.GetStoredValue((UnitStoredValueNames) 14) + previousExitValue;
