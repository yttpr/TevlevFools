...
// Type: TevlevsRapscallions.ApplyShieldByHealthEffect
...
{
  public class ApplyShieldByHealthEffect : EffectSO
  {
    [SerializeField]
      ...
      out int exitAmount)
    {
      ...
      {
        Shield_SlotStatusEffect slotStatusEffect = new Shield_SlotStatusEffect(targetSlotInfo.SlotID, entryVariable, targetSlotInfo.IsTargetCharacterSlot, 0);
